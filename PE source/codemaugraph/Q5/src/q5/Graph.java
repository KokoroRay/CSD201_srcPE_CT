...
public class Graph {
    ...
    ArrayList<String> listConnectComponent = new ArrayList<>();
    int theNumberConnnectComponent = 0;
    String result = "";
...
//                } // nếu đề 8 10 5
        ...
        listConnectComponent.add(resultDFS);
    }
    ...
    public void theNumberOfConnectedComponent() {
        resetIsVisited();
        listConnectComponent.clear();
        theNumberConnnectComponent = 0;
        for (int i = 0; i < numberOfVerties; i++) {
            if (isVisited[i] == false) {
                theNumberConnnectComponent++;
                DFS(i);
            }
        }
    }

    public String theNumberOfConnected() {
//        theNumberOfConnectedComponent();
        result += listConnectComponent.size() + "\r\n";
        for (String str : listConnectComponent) {
