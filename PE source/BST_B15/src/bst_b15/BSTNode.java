...
public class BSTNode {
    ...
    private int data;
    private int count; // truong hop trung gia tri 
    ...
    public BSTNode(int data, int count) {// for blacing BST
        this.data = data;
        this.count = count;
        ...
        if (node.isLeaf()) {
            ...
            if (this.hasRightChild()) {
                if (this.getRightChild().getData() == node.getData()) {
                    this.setRightChild(null); // remove the left child
                    return true;
                }
            }
        }
